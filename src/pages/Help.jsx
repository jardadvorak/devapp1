...
import texts_help from '../config/texts_help';
import ExpandableList from '../components/ExpandableList';

const Help = () => {
    // Get language context
    const { currentLanguage } = useLanguage();
    const currentTexts = texts_help[currentLanguage];
    const help_issues = currentTexts.help_issues;
                ...
                <div style={{...availableWidth, minHeight: availableHeight, backgroundColor: 'transparent', color: `var(--text-color-normal)`}}>        
                    ...
                    <div style={{
                        ...
                        <div style={styles.htmlH1style}>
                            {currentTexts.help_title}
                        </div>

                        <div style={styles.simpleBarStyle}>
                            <div>
                                {Object.keys(help_issues).map((issueKey) => {
                                    const issue = help_issues[issueKey];
                                    return (
